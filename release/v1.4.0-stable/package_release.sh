#!/usr/bin/env bash
# ed2kIA v1.4.0 STABLE - Release Packaging Script
...
cp docs/migration_guide_v1.3_to_v1.4.md "${OUTPUT_DIR}/docs/" 2>/dev/null || true
cp docs/official_launch_announcement_v1.4.md "${OUTPUT_DIR}/docs/" 2>/dev/null || true
cp docs/architecture_v1.4.0.md "${OUTPUT_DIR}/docs/" 2>/dev/null || true
