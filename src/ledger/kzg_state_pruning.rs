//! KZG State Pruning — Sprint 74: Distributed Systems Hardening & Second-Order Resolution
//!
...
impl KzgConfig {
    /// Default Stuartian configuration for production KZG pruning.
...
impl KzgStatePruner {
    ...
    pub fn new() -> Self {
        Self {
            config: KzgConfig::default_stuartian(),
            commitments: Vec::new(),
...
mod tests {
    ...
    fn test_config_default() {
        let config = KzgConfig::default_stuartian();
